...
variable "nfs-srv-disk-size" {
  description = "VM / hostname prefix for the kubernetes cluster."
}

variable "smb-srv-disk-size" {
  description = "VM / hostname prefix for the kubernetes cluster."
}

variable "haproxy-disk-size" {
  description = "VM / hostname prefix for the kubernetes cluster."
}

variable "guest_host_nfs-srv" {
  description = "VM / hostname prefix for the kubernetes cluster."
}

variable "guest_host_smb-srv" {
  description = "VM / hostname prefix for the kubernetes cluster."
}

variable "guest_host_haproxy" {
  description = "VM / hostname prefix for the kubernetes cluster."
}
